  ...
  return (
    <section className="min-h-screen px-6 lg:px-32 py-20 bg-white dark:bg-gray-900 text-gray-900 dark:text-white">
      ...
      <p className="text-center text-lg text-gray-700 dark:text-gray-300 mb-12 max-w-3xl mx-auto">
        These Terms and Conditions govern your use of MyLearnia. Please read them carefully before accessing or using our services.
      </p>
...
const termsSections = [
  {
    ...
    content: "By using our services, you agree to comply with and be legally bound by these Terms and Conditions. If you do not agree, please refrain from using Mylearnia.",
  },
  {
    title: "2. User Responsibilities",
    content: "You agree not to misuse our MyLearnia, engage in illegal activities, or violate the rights of others while using our services.",
  },
  {
